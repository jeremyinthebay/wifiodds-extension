...
Do not use "honest" to signal credibility or candor. The adverb "honestly" and "I'm going to be honest" are already banned above. These are banned too:
...
State the measurement, the gap, or the limit. Skip the virtue label.

### Unicode dashes

Do not use U+2014 EM DASH or U+2013 EN DASH. Use a comma, colon, hyphen-minus, or period.

### Chrome Web Store brand stuffing

Do not list airlines, booking sites, or partner brands in Store copy to chase keywords. Name only the surfaces the listing is actually describing.
